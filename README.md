...
I'm experienced in Rust 🦀, Kubernetes, Distributed Systems, Distributed Algorithms, Transport & Open Street Map Routing, Containerisation, Linux, and GIS. I contribute to a broad range of repositories. 
...
**Transit software**
 - [catenarytransit/catenary-backend](https://github.com/catenarytransit/catenary-backend/) **In continuous production**
Backend system for routing algorithm, schedule ingesting, map, and data parsing. Written in Rust 🦀 & Postgres.
 ...
 - [catenarytransit/via-rail-gtfs-rt](https://github.com/catenarytransit/via-rail-gtfsrt) **Finished!!** Conversion from Via Rail tracker to gtfs-rt vehicles and trips fields.
